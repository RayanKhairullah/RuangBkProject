...
class BiodataController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'nisn'              => 'required|digits_between:8,20|numeric|unique:biodatas,nisn',
            ...
            'telepon'           => ['required', 'regex:/^08[0-9]{8,12}$/'],
            ...
            'no_hp_ayah'        => ['required', 'regex:/^08[0-9]{8,12}$/'],
            'nama_ibu'          => 'nullable|string|max:255',
            'pekerjaan_ibu'     => 'nullable|string|max:255',
            'no_hp_ibu'         => ['required', 'regex:/^08[0-9]{8,12}$/'],
    ...
    public function update(Request $request)
    {
        ...
        $request->validate([
            'nama_siswa'        => 'required|string|max:255',
            'nisn'              => 'required|digits_between:8,20|numeric|unique:biodatas,nisn' . $biodata->id,
            'jenis_kelamin'     => 'required|in:Laki-laki,Perempuan',
            // 'jurusan_id'        => 'required|exists:jurusans,id',
            // 'room_id'          => 'required|exists:rooms,id',
            'kode_rooms'        => 'required|exists:rooms,kode_rooms',
