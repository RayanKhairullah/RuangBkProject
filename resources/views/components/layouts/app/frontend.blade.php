        ...
        <flux:dropdown position="top" align="end">
            ...
            <flux:menu>
                ...
                @can('access teacher dashboard')
                    <flux:menu.separator/>
                    <flux:menu.radio.group>
                        <flux:menu.item href="{{ route('teacher.index') }}" icon="shield">
                            {{ __('global.teacher_dashboard') }}
                        </flux:menu.item>
                    </flux:menu.radio.group>
                @endcan
                ...
                @can('access student dashboard')
                    <flux:menu.separator/>
                    <flux:menu.radio.group>
                        <flux:menu.item href="{{ route('student.index') }}" icon="shield">
                            {{ __('global.student_dashboard') }}
                        </flux:menu.item>
                    </flux:menu.radio.group>
                @endcan
