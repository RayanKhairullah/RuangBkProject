            ...
            <flux:navlist variant="outline">
                <flux:navlist.group :heading="__('Platform')" class="grid">
                    ...
                    @if (auth()->user()->role === App\Enums\UserRole::Teacher)
                        ...
                        <flux:navlist.item icon="list-bullet" :href="route('dashboard')" wire:navigate>{{ __('Rooms') }}</flux:navlist.item>
                        <flux:navlist.item icon="list-bullet" :href="route('dashboard')" wire:navigate>{{ __('Jurusan') }}</flux:navlist.item>
                    ...
                    @if (auth()->user()->role === App\Enums\UserRole::User)
                        <flux:navlist.item icon="list-bullet" :href="route('dashboard')" wire:navigate>{{ __('Biodata') }}</flux:navlist.item>
                        <flux:navlist.item icon="list-bullet" :href="route('dashboard')" wire:navigate>{{ __('Konseling') }}</flux:navlist.item>
                        <flux:navlist.item icon="list-bullet" :href="route('dashboard')" wire:navigate>{{ __('Catatan Prilaku') }}</flux:navlist.item>
                    @endif
