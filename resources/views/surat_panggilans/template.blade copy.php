...
<head>
    ...
    <style>
        ...
        .footer-logo {
            ...
            max-width: 30px;
            display: block;
            margin-left: auto;         /* Center dan beri jarak bawah */
        }
    ...
    <table>
        ...
        <td class="col-right">
            <img src="{{ public_path('images/logosmeabenklu.jpg') }}"
                alt="SMKN 1 Kota Bengkulu" class="footer-logo">

            <p class="tagline">Akreditasi A, Unggul &amp; Terpercaya</p>

            <div class="social-horizontal">
            <a href="https://instagram.com/smkn1kotabengkulu">
                <img src="{{ public_path('images/icon_instagram.png') }}" alt="IG"> @smkn1kotabengkulu
            </a>
            <a href="https://facebook.com/Smkn1KotaBengkulu">
                <img src="{{ public_path('images/icon_facebook.png') }}" alt="FB"> Smkn1 Kota Bengkulu
            </a>
            <a href="https://twitter.com/smkn1kotabkl">
                <img src="{{ public_path('images/icon_twitter.png') }}" alt="TW"> @smkn1kotabkl
            </a>
            </div>
        </td>
        </tr>
