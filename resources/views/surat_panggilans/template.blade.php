...
<head>
    ...
    <style>
        @page {
            size: A4 portrait;
            margin: 15mm 15mm 10mm 15mm; /* lebih sempit atas/kanan/kiri, lebih kecil bawah */
        }
        header, footer {
            position: fixed;
            width: 100%;
        ...
        body {
            ...
            line-height: 1.4;          /* agak dipadatkan */        /* sisa ruang dari header */
            font-family: 'Times New Roman', Times, serif;     /* sisa ruang untuk footer */
        }
        .clear { clear: both; }
        /* Header */
...
<body>
    ...
    <div class="isi">
        ...
        <p><strong>Kelas:</strong> {{ $suratPanggilan->room->tingkatan_rooms }} - {{ $suratPanggilan->room->jurusan->nama_jurusan }}</p>
        <p>Di Tempat</p>
