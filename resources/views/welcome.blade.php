...
<body class="bg-white">
    ...
    <header class="bg-white shadow-sm">
        <div class="container mx-auto px-4 sm:px-6 py-4">
            <div class="flex items-center justify-between">
                ...
                <nav class="hidden md:flex items-center space-x-8">
                    ...
                    <a href="#" class="ml-6 px-6 py-2 bg-[#D4AF37] text-white rounded-lg hover:bg-[#B89C30] transition-colors">
                        Login
                    </a>
                </nav>
        ...
        <div class="md:hidden fixed inset-y-0 right-0 w-64 bg-white shadow-xl z-50 transform translate-x-full transition-transform duration-300 ease-in-out" id="mobileMenu">
            ...
            <div class="px-6 space-y-6">
                ...
                <a href="#" class="block w-full px-4 py-3 bg-[#D4AF37] text-white text-center rounded-lg font-medium">
                    Login
                </a>
            </div>
        </div>
    ...
    <section id="home" class="flex flex-col md:flex-row items-center justify-between px-4 sm:px-12 py-12 md:py-20">
        <div class="md:w-1/2 space-y-6 text-center md:text-left">
            ...
            <a href="#" class="inline-block px-8 py-3 bg-[#D4AF37] text-white rounded-lg font-semibold hover:bg-[#B89C30] transition-colors">
                Mulai Sekarang
            </a>
        </div>
    ...
    <section id="structure" class="py-12 md:py-16">
        <div class="container mx-auto px-4 sm:px-6">
            ...
            <div class="max-w-4xl mx-auto">
                <img src="{{ asset('images/structure1.jpg') }}" alt="Alur Kasus" class="w-full h-auto rounded-lg">
            </div>
        </div>
    </section>

    <!-- Footer -->
    <footer class="bg-blue-900 text-white pt-12 md:pt-16">
        <div class="container mx-auto px-4 sm:px-6">
            ...
            <div class="border-t border-[#D4AF37] mt-12 py-4 text-center">
                <p class="text-sm text-gray-300">
                    © 2025 RuangBk. All rights reserved. | Developed by Veritas Group
                </p>
            </div>
        </div>
    </footer>
