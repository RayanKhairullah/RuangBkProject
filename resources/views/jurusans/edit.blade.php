<x-layouts.app :title="__('Edit Jurusan')">
    <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-6">{{ __('Edit Jurusan') }}</h1>

    <form action="{{ route('jurusans.update', $jurusan) }}" method="POST" class="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
        @csrf
        @method('PUT')
