<section class="w-full">
    <x-page-heading>
        <x-slot:title>Buat Surat Panggilan</x-slot:title>
    </x-page-heading>

    <x-form wire:submit="save" class="space-y-6">
        <flux:input wire:model.live="nomor_surat" label="Nomor Surat" placeholder="Contoh: 012/SP/BK/2025"/>
        <flux:input type="datetime-local" wire:model.live="tanggal_waktu" label="Tanggal & Waktu"/>
        <flux:input wire:model.live="tempat" label="Tempat Konseling" placeholder="Contoh: Ruang BK"/>
        <flux:textarea wire:model.live="tujuan" label="Tujuan Panggilan" placeholder="Contoh: Konseling perilaku"/>
        ...
        <div class="flex gap-2">
            <flux:button type="submit" icon="save" variant="primary">Simpan Surat</flux:button>
