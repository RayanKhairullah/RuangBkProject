<section class="w-full">
    <x-page-heading>
        <x-slot:title>Tambah Catatan Siswa</x-slot:title>
    </x-page-heading>
    ...
    <x-form wire:submit="save" class="space-y-6">
        ...
        <flux:textarea wire:model.live="masalah_dibahas" label="Masalah Dibahas" placeholder="Masalah yang terjadi..." />
        <flux:textarea wire:model.live="tindak_lanjut" label="Tindak Lanjut" placeholder="Langkah tindak lanjut..." />
        <flux:textarea wire:model.live="hasil_akhir" label="Hasil Akhir" placeholder="Kesimpulan hasil..." />

        <flux:input type="number" wire:model.live="poin" label="Poin Pelanggaran" placeholder="Misal: 10" />

        <div class="flex gap-2">
            <flux:button type="submit" icon="save" variant="primary">Simpan</flux:button>
