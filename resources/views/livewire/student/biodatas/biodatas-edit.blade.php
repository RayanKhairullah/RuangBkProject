...
    <x-page-heading>
        <x-slot:title>Edit Biodata Saya</x-slot:title>
        <x-slot:subtitle>Perbarui informasi biodata kamu</x-slot:subtitle>
    </x-page-heading>
...
        <script>
        ...
        // Kode Kelas hanya huruf, 4 karakter, auto uppercase
